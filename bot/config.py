class config:
    BOT_TOKEN = "5176574418:AAFPtwgoFQae97MLwK1ZxJpseM5FDUk7Du4"
    APP_ID = "8884119"
    API_HASH = "d94fe90a1d7ee5ce6f36b20d4ca79280"
    DATABASE_URL = ""
    SUDO_USERS = "5142140533" # Sepearted by space.
...
class Messages:
    ...
    HELP_MSG = [
        ...
        "**Rules & Precautions**\n__1. Don't copy BIG Google Drive Files/Folders. It may hang the bot and your files maybe damaged.\n2. Send One request at a time unless bot will stop all processes.\n3. Don't send slow links @mr_sukkun it first.\n4. Don't misuse, overload or abuse this free service.__",
        
        # Dont remove this ↓ if you respect developer.
         
        "**Join Channel @mukhushi_official**"
        ]
